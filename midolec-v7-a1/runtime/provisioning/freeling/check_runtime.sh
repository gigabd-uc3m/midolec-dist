...
This script only checks the local Midolec V7-a1 FreeLing runtime layout. It does
...
check_freeling_abi_match() {
  ...
  if [[ "$missing" -ne 0 ]]; then
    ...
    echo "Use the runtime libraries published for this Midolec V7-a1 build." >&2
    return 1
  fi
